...
Route::get('/sdetails/{student_id}/{name}/{email}/{phone}',[AdminController::class,'student'])->name('Student.studentdetails');
...
{
    Route::resource('students',App\Http\Controllers\AdminController::class);
